...
int main()
{
    ...
    if(myfile.is_open())
    {
        while(getline(myfile,line))
        {
            ...
            search(pat,a,11);
            currentLine++;
            SearchString(line, "The stranger followed in their tracks, sheathing his sword and dagger. As they passed the tables the remaining customers hid their faces from the dangerous stranger");
        }
    }
